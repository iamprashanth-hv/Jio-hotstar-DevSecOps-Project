...
In Tools section configure in Jenkins:
...
add sonar integration in manage jenkins--> system-->:
![img_9.png](img_9.png)
...
SMTP server --> smtp.gmail.com
SMTP Port ---> 465
Advanced-credentials-->username and password --> gamil and app password + check use ssl
```
